...
public class ParameterHandler {
	...
	public static void SaveToFile(String instanceURL, int testID, ParameterSet paramSet) {
		...
		// SQLHandler.insertSingleParameterSetIteration(subfolder, "Test" + testID,
		// paramSet);
		...
		try (BufferedWriter writer = Files.newBufferedWriter(Paths.get(filePath), Charset.defaultCharset(), StandardOpenOption.APPEND)) {
